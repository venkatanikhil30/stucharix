                ...
                <div className="grid grid-3" style={{ marginBottom: '3rem' }}>
                    ...
                    <div>
                        ...
                        <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', color: 'var(--text-muted)' }}>
                            <li>Email: <a href="https://mail.google.com/mail/?view=cm&fs=1&to=team.stucharix@gmail.com" target="_blank" rel="noopener noreferrer" style={{ transition: 'color 0.2s ease' }} className="hover:text-primary">team.stucharix@gmail.com</a></li>
                            <li style={{ marginTop: '0.5rem', display: 'flex', gap: '1.5rem' }}>
                                <a href="https://www.instagram.com/stucharix/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-light)', transition: 'color 0.2s ease' }} className="hover:text-primary">Instagram</a>
                                <a href="https://x.com/stucharix" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-light)', transition: 'color 0.2s ease' }} className="hover:text-primary">Twitter</a>
                                <a href="https://www.youtube.com/@stucharix" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-light)', transition: 'color 0.2s ease' }} className="hover:text-primary">YouTube</a>
                            </li>
                        </ul>
                    </div>
                </div>
